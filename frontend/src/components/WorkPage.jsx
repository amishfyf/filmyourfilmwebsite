...
import { getProjectMetaLabel, normalizeProjects, ProjectPreviewMedia } from './projectCatalog';
import './styles.css';
import './WorkPage.css';
    ...
    <div className="work-page-shell">
      <header className="site-header site-header-work">
        ...
        <nav className="site-nav">
          <a href="/">Home</a>
          <a aria-current="page" href="#work-grid">Work</a>
      ...
      <main className="work-page-main">
          ...
          {status === 'success' && projects.length ? (
            projects.map((item, index) => (
              ...
              >
                ...
                <div className="work-project-copy">
                  ...
                  <p className="work-project-meta">{getProjectMetaLabel(item, 'full')}</p>
                </div>
              </article>
            ))
          ) : (
            <section className="work-empty-state" aria-live="polite">
              <div className="work-empty-card">
                <h2>{status === 'loading' ? 'Loading work...' : 'No projects found'}</h2>
                <p>
                  {status === 'error'
                    ? errorMessage
        ...
        <section className="work-page-contact" id="work-contact">
          ...
          <div className="work-page-footer">
            <p className="work-page-footer-brand">Creatiwe.Studio</p>
      ...
      <VideoModal onClose={() => setActiveProject(null)} project={activeProject} />
    </div>
  );
}
